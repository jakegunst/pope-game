...
class GameEngine {
    ...
    // Exit sprite configuration - ADDED FOR PEQUOD'S
...
this.exitConfig = {
    ...
    doorBounds: {    // The actual door area
        offsetX: 88,     // Move left (was 108)
        offsetY: 216,    // Keep same height
        width: 40,       // Keep same width
...
/**
 * Check if level is complete - UPDATED FOR PEQUOD'S DOOR
 */
checkLevelComplete() {
